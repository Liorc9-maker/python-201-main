...
# You could use it to keep track of your player's inventory across multiple instances of your game.
# Functions: Refactor your code to use functions for the different actions that your player can take. 
# Then, use your game loop to call the functions that the player chooses.
# Documentation: Add docstrings and type hints to your functions. 
# Explain what they do and learn to use good practices for writing readable and reusable functions right from the start.
...
def battle(opponent):
    ...
    opp_power = opp_roll + (2 if opponent == "goblin" else 6)
